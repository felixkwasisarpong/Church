...
Route::group([ 'middleware' => [ 'auth'],'prefix' => 'programs'], function(){
    Route::resource('view', WeeklyProgramController::class);
   
});
Route::group([ 'middleware' => [ 'auth'],'prefix' => 'Bible-Study'], function(){
    Route::get('add', 'BibleStudyController@addTopics')->name('addTopics');
    Route::get('view', 'BibleStudyController@viewTopics')->name('viewTopics');
});
...
Route::group([ 'middleware' => [ 'auth'],'prefix' => 'Financials'], function(){
    Route::get('index', 'FinancialsController@index');
  
});

Route::group([ 'middleware' => [ 'auth'],'prefix' => 'cell'], function(){
    Route::get('view-cell', 'cellController@viewCell');
    Route::get('add-cell', 'cellController@addCell');
    Route::get('add-cell-topic', 'cellController@addCellTopic');
    Route::get('view-cell-topic', 'cellController@viewCellTopic');
